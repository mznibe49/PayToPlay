...
public class AuthEntryPointJwt implements AuthenticationEntryPoint {
    ...
    /*
        AuthEntryPointJwt class  implements AuthenticationEntryPoint interface. Then override the commence() method.
    ...
    public void commence(HttpServletRequest request, HttpServletResponse response, AuthenticationException authException)
        ...
        // to customize the response data, just use an ObjectMapper like following code instead of the previous one
        /*
